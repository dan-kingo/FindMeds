...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-3xl border border-primary-200/70 bg-gradient-to-r from-primary-100 via-orange-50 to-amber-100 p-6 shadow-soft">
        <h1 className="text-2xl font-bold text-slate-900">Admin Dashboard</h1>
        <p className="text-slate-600">
          Live operations snapshot across the FindMeds network.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {stats.map((stat) => {
          ...
          return (
            <div key={stat.name} className="card border-t-4 border-primary-300">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        <div className="card">
          <div className="card-header bg-primary-50/60">
            <h3 className="text-lg font-semibold text-slate-900">
              Most Requested Medicines
            </h3>
          </div>
          <div className="card-body">
            {analytics?.mostRequestedMedicines &&
            analytics.mostRequestedMedicines.length > 0 ? (
        ...
        <div className="card">
          <div className="card-header bg-orange-50/70">
            <h3 className="text-lg font-semibold text-slate-900">
              Quick Actions
            </h3>
          </div>
      ...
      {/* System Status */}
      <div className="card">
        <div className="card-header bg-success-50/60">
          <h3 className="text-lg font-semibold text-slate-900">
            System Status
          </h3>
        </div>
