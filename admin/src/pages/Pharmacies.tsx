...
const Pharmacies = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-3xl border border-emerald-200/70 bg-gradient-to-r from-emerald-50 to-teal-100 p-6 shadow-soft">
        <h1 className="text-2xl font-bold text-slate-900">
          Pharmacy Management
        </h1>
        <p className="text-slate-600">
          Approve, reject, and supervise active partner pharmacies.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {filteredPharmacies.map((pharmacy) => (
          <div
            key={pharmacy._id}
            className="card border-l-4 border-emerald-300"
          >
            <div className="card-body">
              ...
              <div className="flex space-x-2">
                ...
                {pharmacy.status === "approved" && (
                  <div className="text-center w-full">
                    <span
                      className={`text-sm ${pharmacy.isActive ? "text-green-600" : "text-slate-500"}`}
                    >
