...
export default function OtpVerificationScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <Header title={isRegistration === 'true' ? "Complete Registration" : "Verifying"} showBack />
      
      <View style={styles.content}>
        <Animated.View entering={FadeInDown.delay(200).duration(600)}>
          <Text variant="headlineSmall" style={styles.title}>
            {isRegistration === 'true' ? 'Create Your Account' : 'Verifying your account...'}
          </Text>
          <Text variant="bodyMedium" style={[styles.subtitle, { color: theme.colors.onSurfaceVariant }]}>
            {isRegistration === 'true' ? 'Set a password to finish registration.' : `Phone: ${phone}`}
          </Text>
        </Animated.View>
